      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?sayfa=mesajlar"><i class="fa fa-envelope"></i> <span>MESAJLAR</span></a></li>
		 <li class="treeview">
          <a href="index.php?sayfa=profil"><i class="fa fa-folder"></i> <span>PROJELER</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
		...
		<li class="treeview">
          <a href="#"><i class="fa fa-th"></i> <span>DUYURULAR</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
		...
		<li class="treeview">
          <a href="#"><i class="fa fa-calendar"></i> <span>ETKİNLİKLER</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
